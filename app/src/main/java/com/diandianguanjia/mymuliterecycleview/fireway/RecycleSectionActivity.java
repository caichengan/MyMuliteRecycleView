...
public class RecycleSectionActivity  extends AppCompatActivity implements ItemClickListener {
    RecyclerView mRecyclerView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_recycle_section);

        //setting the recycler view
        mRecyclerView = (RecyclerView) findViewById(R.id.recycleViewlist);
